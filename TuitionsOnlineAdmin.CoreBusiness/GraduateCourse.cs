...
namespace TuitionsOnlineAdmin.CoreBusiness
{
    ...
    {
        //property to store graduate course Id
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int GraduateCourseId { get; set; }

        //property to store graduate course name
        ...
        [MaxLength(255, ErrorMessage = "The graduate course name you have entered is too long. Please restrict the name to less than 255 alphabets.")]
